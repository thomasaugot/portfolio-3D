        ...
        <div className="relative group/container">
          ...
          <div className="relative bg-bg-surface/96 backdrop-blur-sm border border-border rounded-2xl p-6 shadow-2xl [html[data-theme='light']_&]:border-[#c8b99f] [html[data-theme='light']_&]:bg-[#f8f3e9]/96 [html[data-theme='light']_&]:shadow-[0_28px_80px_rgba(16,185,129,0.08),0_18px_40px_rgba(149,115,37,0.12)]">
            ...
            <div className="mb-6">
              ...
              <h2 id="contact-section-title" className="text-2xl lg:text-3xl font-bold text-text leading-tight">
              ...
              {SOCIAL_LINKS.map((social) => {
                ...
                return (
                  <a
                    ...
                    className="group flex items-center gap-4 p-3 -mx-3 rounded-xl transition-all duration-300 hover:bg-text/5"
                  >
                    <div
                      className="w-11 h-11 bg-bg-surface border border-border flex items-center justify-center transition-all duration-300 group-hover:border-primary group-hover:scale-110"
                      style={{
                        clipPath: "polygon(15% 0, 85% 0, 100% 15%, 100% 85%, 85% 100%, 15% 100%, 0 85%, 0 15%)"
                      }}
                    >
                      <Icon className="w-5 h-5 text-text/82 group-hover:text-primary transition-colors duration-300" />
                    </div>
                    <div className="flex-1 min-w-0">
                      <p className="text-[11px] text-muted uppercase tracking-wider font-mono">{social.label}</p>
                      <p className="text-[14px] text-text/90 font-medium group-hover:text-primary transition-colors duration-300">{social.handle}</p>
                    </div>
                    <ArrowUpRight className="w-4 h-4 text-muted group-hover:text-primary transition-all duration-300 group-hover:translate-x-0.5 group-hover:-translate-y-0.5" />
                  </a>
                );
              })}
            </div>
            ...
            <div className="mt-6 pt-4 border-t border-border flex items-center gap-3">
              ...
              <span className="text-sm text-text/82 font-mono">
                {t("footer.available")}
              </span>
            </div>
          </div>
