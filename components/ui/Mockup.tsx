...
export function Mockup({ variant, src, alt, className = "" }: MockupProps) {
    ...
    return (
      <div className={`relative w-full ${className}`}>
        <div className="relative" style={{ aspectRatio: "16/10" }}>
          <div className="absolute inset-0 rounded-2xl shadow-2xl bg-surface" style={{ padding: "3.5%" }}>
  ...
  if (variant === "mobile") {
    return (
      <div className={`relative w-full ${className}`} style={{ aspectRatio: "9/19.5" }}>
        <div className="absolute inset-0 rounded-[1.25rem] sm:rounded-[1.75rem] md:rounded-[2.5rem] bg-surface shadow-xl border border-border" style={{ padding: "2.5%" }}>
  ...
  if (variant === "tablet") {
    return (
      <div className={`relative w-full ${className}`} style={{ aspectRatio: "4/3" }}>
        <div className="absolute inset-0 rounded-3xl bg-surface shadow-2xl" style={{ padding: "3%" }}>
    ...
    return (
      <div className={`relative w-full ${className}`}>
        <div className="relative w-full" style={{ aspectRatio: "16/10" }}>
          <div className="absolute inset-0 rounded-2xl bg-surface shadow-2xl" style={{ padding: "2%" }}>
        ...
        <div className="relative w-full flex flex-col items-center">
          <div className="w-[4%] h-[40px] bg-gradient-to-b from-border to-surface" />
          <div className="w-[25%] h-[15px] rounded-full bg-surface shadow-lg" />
        </div>
      </div>
    );
  }
  ...
  if (variant === "browser") {
    return (
      <div className={`relative w-full rounded-2xl overflow-hidden bg-surface shadow-2xl ${className}`}>
