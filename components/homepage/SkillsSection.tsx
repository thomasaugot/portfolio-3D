        ...
        <div className="grid md:grid-cols-2 gap-6 md:gap-8 mb-16 md:mb-20">
          {services.map((service, index) => (
            ...
            >
              ...
              <div className="relative bg-bg backdrop-blur-xl rounded-2xl md:rounded-3xl p-6 md:p-8 lg:p-10 transition-all duration-500 h-full overflow-hidden border border-border/30">
